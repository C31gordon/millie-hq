...
const MOCK = {
  ...
  tasks: [
    ...
    { id: 38, name: 'Discuss: Pre-IPO Investing Strategy', agent: 'Millie', status: 'scheduled', priority: 'high', date: '2026-02-18 02:00', due: '', description: 'Revisit investment strategy with focus on pre-IPO opportunities. Research platforms (EquityZen, Forge, Linqto), allocation sizing, risk framework, and sectors to target (AI, proptech, fintech). To be discussed with Courtney.' },
    // In Progress
